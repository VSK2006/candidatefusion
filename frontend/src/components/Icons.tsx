...
export const CsvIcon = ({ className }: Props) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-3.75.125v-1.5c0-.621.504-1.125 1.125-1.125m0 0h17.25m-17.25 0a1.125 1.125 0 01-.375-.063M4.125 15h17.25m0 0a1.125 1.125 0 01.375.063M21.375 15v1.5c0 .621-.504 1.125-1.125 1.125m0 0h-17.25M3.375 9h17.25M3.375 9a1.125 1.125 0 01-1.125-1.125V6.75m1.125 2.25h17.25m0 0a1.125 1.125 0 00.375-.063m-17.625.063c.207 0 .413-.026.613-.075" />
  </svg>
)
...
export const AcademicIcon = ({ className }: Props) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
